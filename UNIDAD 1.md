...
A["Tipos de Proposiciones"]

A --> B["Simples"]
A --> C["Compuestas"]

B --> D["Expresan una sola idea"]
B --> E["No contienen conectores lógicos"]

C --> F["Unión de dos o más proposiciones simples"]
C --> G["Utilizan conectores lógicos"]
...
<details>
<summary>DISYUNCIÓN EXCLUSIVA (⊕)</summary>
